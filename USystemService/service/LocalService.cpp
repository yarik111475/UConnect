...
void LocalService::init_spdlog()
{
    ...
    const std::string path_to_log_file=log_path_success ? m_app_dir_path.toStdString() + std::string{"/../logs/log.txt"}
...
bool LocalService::init_ssl_configuration()
{
    bool success {true};
...
bool LocalService::init_addresses()
{
    bool success {true};
...
LocalService::LocalService(int argc, char **argv)
