...
TEMPLATE = lib
DEFINES += LOCALNETWORKAUDIT_LIBRARY
...
win32:CONFIG(debug, debug|release){
    LIBS += -L$$OUT_PWD/../../../Lib/snmp++_win/build/debug -lsnmp++
}
else{
    LIBS += -L$$OUT_PWD/../../../Lib/snmp++_win/build/release -lsnmp++
}
...
HEADERS += \
    #TaskLocalNetworkAudit_global.h \
    TaskItem.h \
    TaskPlugin.h \
